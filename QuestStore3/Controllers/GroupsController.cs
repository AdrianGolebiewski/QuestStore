...
namespace QuestStore3.Data
{
    public class GroupsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                return View(await _context.Group.Where(s => s.MentorId.ToString() == userId).ToListAsync());
            }
        ...
        [Authorize(Roles = "Admin,Mentor")]
        [HttpPost]
        public async Task<IActionResult> CreateGroup([Bind("GroupID,Name,Description, MentorId")] Group group)
        {
